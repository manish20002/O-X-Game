...
def btnclick(buttons):
    ...
    if buttons["text"] ==""and bclick==True:
        ...
        tkinter.messagebox.showinfo("O&X", "Button already clicked")
...
def checkForWin():
    if(button1['text']=='X'and button2['text']=='X'and button3['text']=='X'
      ...
      disableButton()
      tkinter.messagebox.showinfo("O&X", playera)
    elif flag ==8:
        tkinter.messagebox.showinfo("O&X","It is tie")
       ...
       or button3['text']=='O'and button5['text']=='O'and button7['text']=='O'):
        disableButton()
        tkinter.messagebox.showinfo("O&X", playerb)
